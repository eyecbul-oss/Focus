...
export default function FocusScreen() {
  ...
  const finishPomodoro = useFocusStore((s) => s.finishPomodoro);
    ...
    <GradientBackground>
      <ScrollView contentContainerStyle={[styles.container, fullscreen && styles.fullscreen]}>
        ...
        <View style={styles.actions}>
          ...
          <NeonButton title="Bitir" variant="danger" onPress={() => { finishPomodoro(Math.round(focusSeconds / 60), "Focus"); timer.reset(); }} />
